    ...
    <div style="width: 100%;background-color: #EEEEEE; padding: 0;margin: 0">
        <div class="container-fw" style="background-color: white">
            <form id="form-sign" style="margin: 0;padding-bottom: 20px  ">
                ...
                <h3 align="center" style="color: #4a1a67; font-weight: 600">Đăng Ký Nhà Tuyển Dụng</h3>
                ...
                <h4 class="title_sign"><span class="line_vertical"></span>Thông tin công ty</h4>
                <table class="table-sign">
                    <tr>
                        <td class="first">
                            Tên công ty:
                    ...
                    <tr>
                        ...
                        <td class="second">
                            <select class="minimal" name="selectsex" style="width: 269px" required>
                                <option selected disabled>Quy mô</option>
                                <option>Trên 500 người</option>
                                <option>200 - 500 người</option>
                                <option>100 - 200 người</option>
                                <option>50 - 100người</option>
                                <option>20 - 50người</option>
                    ...
                    <tr>
                        ...
                        <td class="second">
                            ...
                            <input type="text"  name="phonenumber" class="input-custom" required>
                        </td>
                    </tr>
